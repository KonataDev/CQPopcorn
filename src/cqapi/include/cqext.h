 ...
 * @param instance extension instance.
 * @param subtype message subtypes, 11/from friend, 1/from online, 2/from group, 3/from discuss
 * @param msgid messge id.
 * @param account from account.
 * @param content message content.
 * @param font message font.
 * @return return ignore or handled.
 */
cq_eventctl_t cqext_event_private_msg(cq_ext_instance_t instance, int32_t subtype, 
  uint32_t msgid, uint64_t account, char* content, uint32_t font);
